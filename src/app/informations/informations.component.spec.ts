...
describe(`${InformationsComponent.name}`, () => {
  ...
  describe('should have a text in section about curriculum when component renders', () => {
    ...
    it('should have a subtitle with contain text "O Duolingo for Schools utiliza..." when component renders', () => {
    ...
    it('should have a image with the alt text "currículo alinhado a padrões de aprendizagem no Duolingo Schools" when component renders', () => {
  ...
  describe('tests from section about fun and personalized tasks', () => {
    ...
    it('should have a subtitle with contain text "As tarefas combinam o melhor da inteligência artificial..." when component renders', () => {
      const subtitle = nativeElement.querySelector(
        `${containerClass} span`
      ) as HTMLSpanElement;
    ...
    it('should have a image with the alt text "Tarefas divertidas e personalizadas no Duolingo Schools" when component renders', () => {
      const image = nativeElement.querySelector(
        `${containerClass} img`
      ) as HTMLImageElement;
  ...
  describe('tests from section about informations and progress from students', () => {
    ...
    it('should have a title with contain text "informações sobre o progresso dos alunos" when component renders', () => {
      const title = nativeElement.querySelector(
        `${containerClass} h3`
      ) as HTMLElement;
    ...
    it('should have a subtitle with contain text "Veja o desempenho dos seus alunos com informações como nível de acertos e tempo dedicado aos estudos." when component renders', () => {
      const subtitle = nativeElement.querySelector(
        `${containerClass} span`
      ) as HTMLSpanElement;
    ...
    it('should have a image with the alt text "informações sobre o progresso dos alunos" when component renders', () => {
      const image = nativeElement.querySelector(
        `${containerClass} img`
      ) as HTMLImageElement;
